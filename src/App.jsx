            ...
            <div className="max-w-xl m-8 p-8 flex flex-col bg-gray-50 shadow-2xl rounded">
                ...
                <div className="flex flex-row items-center align-center">
                    <motion.div
                        ...
                        <CircleProgress text={hours} percentage={hours / 24 * 100} color={circleColor1} />
                    </motion.div>
                    <motion.div
                        initial={{ scale: 0 }} animate={{ scale: 1 }}
                        className="p-2 flex flex-col items-center align-center">
                        <p className="text-2xl font-bold text-orange-500">Minutes</p>
                        <CircleProgress text={minutes} percentage={minutes / 60 * 100} color={circleColor2} />
                    </motion.div>
                    <motion.div
                        initial={{ scale: 0 }} animate={{ scale: 1 }}
                        className="p-2 flex flex-col items-center align-center">
                        <p className="text-2xl font-bold text-red-500">Seconds</p>
                        <CircleProgress text={seconds} percentage={seconds / 60 * 100} color={circleColor3} />
                    </motion.div>
                </div>
            </div>
